...
const PureSignupDoctor = (props) => {
  ...
  return (
    ...
    <Header transparent>
          <Left>
            <Button transparent onPress={() => props.navigation.navigate('SignupStepTwo')}>
      ...
      <Content>
        ...
        <Form style={styles.form}>
          ...
          <Item floatingLabel style={styles.input}>
            <Label style={styles.textWhite}>Address</Label>
            <Input style={styles.textWhite} />
          </Item>
        </Form>
      </Content>
      <Fab
        ...
        onPress={() => props.navigation.navigate('SignupStepFour')}>
...
export const SignupDoctor = (PureSignupDoctor);
